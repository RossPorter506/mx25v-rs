...
pub type AsyncMX25V512<SPI>  = AsyncMX25V<_512K, false, SPI>;
/// Async type alias for the MX25V5126 subfamily
pub type AsyncMX25V5126<SPI> = AsyncMX25V<_512K, false, SPI>;
/// Async type alias for the MX25V512F subfamily
pub type AsyncMX25V512F<SPI> = AsyncMX25V<_512K, true, SPI>;
