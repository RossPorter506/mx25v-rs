...
mod tests {
    ...
    use mx25v::{SECTOR_SIZE, blocking::MX25V1606};
    ...
    #[init]
    async fn init() -> MX25V1606<ExclusiveDevice<Spim<'static, SPI3>, Output<'static>, Delay>> {
        ...
        MX25V1606::new(spi_dev)
    }

    #[test]
    async fn basic(
        mut memory: MX25V1606<ExclusiveDevice<Spim<'static, SPI3>, Output<'static>, Delay>>,
    ) {
        let mut buff = [0];
        let addr = 0;
    ...
    async fn trait_capacity(
        memory: MX25V1606<ExclusiveDevice<Spim<'static, SPI3>, Output<'static>, Delay>>,
    ) {
